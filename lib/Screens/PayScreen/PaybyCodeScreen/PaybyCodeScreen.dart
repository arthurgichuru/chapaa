...
class PaybyCodeScreen extends StatefulWidget {
  @override
  _PaybyCodeScreenState createState() => _PaybyCodeScreenState();
}

class _PaybyCodeScreenState extends State<PaybyCodeScreen> {
  ...
  final mytillNumberController = TextEditingController();
          ...
          child: ListView(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text('Enter Till and Amount.', textAlign: TextAlign.center,style: TextStyle(color: Colors.blueAccent, fontSize: 28),
                ),
              ),
              SizedBox(height: 20),
              Padding(
                ...
                child: TextFieldWidget(
                  ...
                  controller: mytillNumberController,
                  passwordText: false,
                  labelText: 'Merchant Till',
                ),
              ),
              SizedBox(height: 10,),
              Padding(
